...
import (
	...
	"github.com/chioshinu/maroto/v2/pkg/components/image"
	"github.com/chioshinu/maroto/v2/pkg/components/row"
	"github.com/chioshinu/maroto/v2/pkg/components/signature"
...
func buildFooter() []core.Row {
	return []core.Row{
		row.New(10).Add(
			...
			text.NewCol(5, "Discussions: https://github.com/chioshinu/maroto/issues/257"),
			text.NewCol(5, "Branch: https://github.com/chioshinu/maroto/tree/v2"),
		),
	}
}
