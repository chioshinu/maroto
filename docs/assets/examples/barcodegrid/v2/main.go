...
import (
	...
	"github.com/chioshinu/maroto/v2/pkg/consts/barcode"
...
func GetMaroto() core.Maroto {
	...
	m.AddRow(40,
		code.NewBarCol(2, "https://github.com/chioshinu/maroto", props.Barcode{
			Percent: 50,
		}),
		code.NewBarCol(4, "https://github.com/chioshinu/maroto", props.Barcode{
			Percent: 75,
		}),
		code.NewBarCol(6, "https://github.com/chioshinu/maroto", props.Barcode{
			Percent: 100,
		}),
	)
