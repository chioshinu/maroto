...
func GetMaroto() core.Maroto {
	...
	m.AddRow(40,
		code.NewQrCol(2, "https://github.com/chioshinu/maroto", props.Rect{
			Percent: 50,
		}),
		code.NewQrCol(4, "https://github.com/chioshinu/maroto", props.Rect{
			Percent: 75,
		}),
		code.NewQrCol(6, "https://github.com/chioshinu/maroto", props.Rect{
			Percent: 100,
		}),
	)
