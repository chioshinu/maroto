...
func GetMaroto() core.Maroto {
	...
	m.AddRow(40,
		code.NewMatrixCol(2, "https://github.com/chioshinu/maroto", props.Rect{
			Percent: 50,
		}),
		code.NewMatrixCol(4, "https://github.com/chioshinu/maroto", props.Rect{
			Percent: 75,
		}),
		code.NewMatrixCol(6, "https://github.com/chioshinu/maroto", props.Rect{
			Percent: 100,
		}),
	)
